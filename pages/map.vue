<template>
  <div class="flex flex-col">
    ...
    <!-- Resources Section -->
    <section class="bg-gray-50 border-t border-gray-200 p-6">
      <div class="max-w-7xl mx-auto">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          ...
          >
            ...
            <span class="text-sm font-medium">Know Your Rights</span>
          </a>
          ...
          >
            ...
            <span class="text-sm font-medium">College of Policing</span>
          </a>
